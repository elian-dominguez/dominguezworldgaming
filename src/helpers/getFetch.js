...
export const games = [
    { id: "1", categoria: "playstation", title: 'FIFA 21', description: "FIFA 21 es la nueva entrega del simulador de fútbol de EA Sports, el juego deportivo más influyente del mundo.", image: 'https://media.vandal.net/m/86853/fifa-21-202092911423764_1.jpg', price: 9000},
    ...
    { id: "9", categoria: "nintendo", title: "Darksiders Warmastered Edition", description: "Las fuerzas del mal engañaron a Guerra, el primer jinete del Apocalipsis, para desencadenar prematuramente el fin del mundo. Ahora lo acusan de incumplir la ley sagrada e incitar un conflicto entre el Cielo y el Infierno en el que las fuerzas demoníacas derrotaron a las huestes celestiales y conquistaron la Tierra.", image: 'https://uvejuegos.com/img/caratulas/57403/wiiu.jpg', price: 4400}
]
