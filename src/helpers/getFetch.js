...
export const games = [
    { id: "1", categoria: "playstation", title: 'FIFA 21', description: "FIFA 21 es la nueva entrega del simulador de fútbol de EA Sports, el juego deportivo más influyente del mundo.", image: fifa21, price: '$9.000' },
    ...
    { id: "3", categoria: "playstation", title: 'Resident Evil 7', description: "La saga de terror de Capcom vuelve a los orígenes con una evolución del Survival Horror que marca un nuevo comienzo. El miedo, la tensión y los rompecabezas imposibles están de vuelta por todo lo alto.", image: r7, price: '$4.100' },
    { id: "4", categoria: "xbox", title: "Call of Duty: Black Ops III", description: "Bienvenido a 2065. Una nueva clase de soldados de operaciones encubiertas surge mientras que la línea que separa a la humanidad de la alta tecnología robótica propia de los conflictos armados se vuelve difusa.", image: cod3, price: '6.500'},
